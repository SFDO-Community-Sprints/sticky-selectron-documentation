...
- <img alt="Sample Account Flow Sticky Selectron Configuration"  src="/sticky-selectron-documentation/docs/Assets/SampleAccountFlow_Configuration.png" width="80%" >
